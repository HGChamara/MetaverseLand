...
contract Land is ERC721 {
    ...
    constructor(
        ...
        buildings.push(
            Building("City Office", address(0x0), 0, 0, 0, 10, 10, 10)
        );
        buildings.push(Building("Cricket Stadium", address(0x0), 0, 10, 0, 10, 5, 3));
        buildings.push(
            Building("University", address(0x0), 0, -10, 0, 10, 5, 3)
        );
        buildings.push(
            Building("City Shopping Center", address(0x0), 10, 0, 0, 5, 25, 5)
        );
        buildings.push(
            Building("School", address(0x0), -10, 0, 0, 5, 25, 5)
        );
    }
